...
public class Column {
	...
	this(c.getTable(), c.getSqlType(), c.getSqlTypeName(), c
		.getColumnName(), c.getSize(), c.getDecimalDigits(), c.isPk(),
		c.isNullable(), c.isIndexed(), c.isUnique(), c
    ...
    public boolean getDecimalDigitsGtZero() {
	return _decimalDigits > 0;
    }
    ...
    /**
     * getColumnNameTrimPrefix:去前缀. <br/>
     * 
     * @author lifeifei
     * @date 2016年3月11日下午2:06:56
     * @return String
     */
    public String getColumnNameTrimPrefix() {
	return StringHelper.uncapitalize(getColumnName().replaceFirst(
		GeneratorProperties.getProperty(this._table.sqlName), ""));
    }

    /**
     * getColumnNameTrimPrefix:去前缀.后首字母大写 <br/>
     * 
     * @author lifeifei
     * @date 2016年3月11日下午2:06:56
     * @return String
     */
    public String getColumnNameTrimPrefixFirstLower() {
	return StringHelper.capitalize(getColumnNameTrimPrefix());
    }
	...
	columnAlias = StringHelper.defaultIfEmpty(getRemarks(),
